...
(function(){"use strict";var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,A,B,C,D,E,F,G,H,I;a=self;b=a.Site=a.Site||{};c=b.WorldTour=b.WorldTour||{};d=a.EventTarget;e=a.Node;f=a.Element;g=a.HTMLElement;h=a.WebSharper=a.WebSharper||{};i=h.Operators=h.Operators||{};j=h.JavaScript=h.JavaScript||{};k=j.Pervasives=j.Pervasives||{};l=b.D3Extras=b.D3Extras||{};m=l.D3=l.D3||{};n=h.Arrays=h.Arrays||{};o=a.WindowOrWorkerGlobalScope;p=h.Concurrency=h.Concurrency||{};q=a.Object;r=a.StartupCode$D3$Client=a.StartupCode$D3$Client||{};s=h.Obj=h.Obj||{};t=p.AsyncBody=p.AsyncBody||{};u=h.Unchecked=h.Unchecked||{};v=p.CT=p.CT||{};w=p.Scheduler=p.Scheduler||{};x=h.Enumerator=h.Enumerator||{};y=a.StartupCode$WebSharper_Main$Concurrency=a.StartupCode$WebSharper_Main$Concurrency||{};z=a.Error;A=h.OperationCanceledException=h.OperationCanceledException||{};B=h.CancellationTokenSource=h.CancellationTokenSource||{};C=x.T=x.T||{};D=a.d3;E=D&&D.geo;F=a.IntelliFactory;G=F&&F.Runtime;H=a.console;I=a.Date;c.Main=function(){c.Render(self.document.getElementById("main"));};c.Render=function(J){var K,L,M,N,O,P,Q;K=960;L=500;M=E.orthographic().scale(248).clipAngle(90);N=D.select(J).append("h1");O=D.select(J).append("canvas").attr("width",K).attr("height",L).node().getContext("2d");P=E.path().projection(M).context(O);p.Start((Q=null,p.Delay(function(){var R;R={type:"sphere"};return p.Bind(m.Json("/world-110m.json"),function(S){return p.Bind(m.Tsv("/world-country-names.tsv"),function(T){var U,V,W,X;function Y(Z){D.transition().duration(1250).each("start",G.CreateFuncWithArgs(function(){N.text(n.get(X,Z).name);})).tween("rotate",function(){var _0,_1;_0=E.centroid(n.get(X,Z));_1=D.interpolate(M.rotate(),[-_0[0],-_0[1],0]);return function(_2){var _3;_3=_1(_2);M.rotate([_3[0],_3[1],_3[2]]);O.clearRect(0,0,K,L);O.fillStyle="#bbb";O.beginPath();P(U);O.fill();O.fillStyle="#f00";O.beginPath();P(n.get(X,Z));O.fill();O.strokeStyle="#fff";O.lineWidth=0.5;O.beginPath();P(W);O.stroke();O.strokeStyle="#000";O.lineWidth=2;O.beginPath();P(R);return O.stroke();};}).transition().each("end",G.CreateFuncWithArgs(function(){Y(Z+1);}));}U=c.topojson().feature(S,S.objects.land);V=c.topojson().feature(S,S.objects.countries).features;W=c.topojson().mesh(S,S.objects.countries,function(Z){return Z[0]!==Z[1];});X=n.sortBy(function(Z){return Z.name;},n.filter(function(Z){return n.exists(function(_0){return Z.id==_0.id&&(Z.name=_0.name,true);},T);},V));Y(0);return p.Return(null);});});})),null);};c.topojson=function(){r.$cctor();return r.topojson;};i.FailWith=function(J){throw new z(J);};k.NewFromSeq=function(J){var K,L,M;K={};L=x.Get(J);try{while(L.MoveNext()){M=L.Current();K[M[0]]=M[1];}}finally{if(typeof L=="object"&&"Dispose"in L)L.Dispose();}return K;};m.Json=function(J){return l.Defer(function(K){D.json(J,G.CreateFuncWithArgs(K));});};m.Tsv=function(J){return l.Defer(function(K){D.tsv(J,G.CreateFuncWithArgs(K));});};l.Defer=function(J){return p.FromContinuations(function(K,L){return J(function(M){if(M[0])L(new z("Defer: failed"));else K(M[1]);});});};n.filter=function(J,K){var L,M,N;L=[];for(M=0,N=K.length-1;M<=N;M++)if(J(K[M]))L.push(K[M]);return L;};n.exists=function(J,K){var L,M,N,O;L=false;M=0;O=n.length(K);while(!L&&M<O)if(J(K[M]))L=true;else M=M+1;return L;};n.sortBy=function(J,K){return n.map(function(L){return L[0];},n.mapi(function(L,M){return[M,[J(M),L]];},K).sort(function(L,M){return u.Compare(L[1],M[1]);}));};n.mapi=function(J,K){var L,M,N;L=new a.Array(K.length);for(M=0,N=K.length-1;M<=N;M++)L[M]=J(M,K[M]);return L;};n.map=function(J,K){var L,M,N;L=new a.Array(K.length);for(M=0,N=K.length-1;M<=N;M++)L[M]=J(K[M]);return L;};n.get=function(J,K){n.checkBounds(J,K);return J[K];};n.checkBounds=function(J,K){if(K<0||K>=J.length)i.FailWith("Index was outside the bounds of the array.");};n.length=function(J){return J.dims===2?J.length*J.length:J.length;};p.Delay=function(J){return function(K){try{(J(null))(K);}catch(L){K.k({$:1,$0:L});}};};p.Bind=function(J,K){return p.checkCancel(function(L){J(t.New(function(M){var N;if(M.$==0){N=M.$0;p.scheduler().Fork(function(){try{(K(N))(L);}catch(O){L.k({$:1,$0:O});}});}else p.scheduler().Fork(function(){L.k(M);});},L.ct));});};p.Return=function(J){return function(K){K.k({$:0,$0:J});};};p.Start=function(J,K){var L,M;L=(M=(p.defCTS())[0],K==null?M:K.$0);p.scheduler().Fork(function(){if(!L.c)J(t.New(function(N){if(N.$==1)p.UncaughtAsyncError(N.$0);},L));});};p.checkCancel=function(J){return function(K){if(K.ct.c)p.cancel(K);else J(K);};};p.defCTS=function(){y.$cctor();return y.defCTS;};p.UncaughtAsyncError=function(J){H.log("WebSharper: Uncaught asynchronous exception",J);};p.cancel=function(J){J.k({$:2,$0:new A.New(J.ct)});};p.scheduler=function(){y.$cctor();return y.scheduler;};p.FromContinuations=function(J){return function(K){var L;function M(N){if(L[0])i.FailWith("A continuation provided by Async.FromContinuations was invoked multiple times");else{L[0]=true;p.scheduler().Fork(N);}}L=[false];J(function(N){M(function(){K.k({$:0,$0:N});});},function(N){M(function(){K.k({$:1,$0:N});});},function(N){M(function(){K.k({$:2,$0:N});});});};};r.$cctor=function(){r.$cctor=a.ignore;r.topojson=self.topojson;};s=h.Obj=G.Class({Equals:function(J){return this===J;}},null,s);s.New=G.Ctor(function(){},s);t.New=function(J,K){return{k:J,ct:K};};u.Compare=function(J,K){var L,M,N,O,P,Q;if(J===K)return 0;else{M=typeof J;switch(M=="function"?1:M=="boolean"?2:M=="number"?2:M=="string"?2:M=="object"?3:0){case 0:return typeof K=="undefined"?0:-1;case 1:return i.FailWith("Cannot compare function values.");case 2:return J<K?-1:1;case 3:if(J===null)N=-1;else if(K===null)N=1;else if("CompareTo"in J)N=J.CompareTo(K);else if("CompareTo0"in J)N=J.CompareTo0(K);else if(J instanceof a.Array&&K instanceof a.Array)N=u.compareArrays(J,K);else if(J instanceof a.Date&&K instanceof a.Date)N=u.compareDates(J,K);else{O=[0];for(var R in J)if(function(S){return!J.hasOwnProperty(S)?false:!K.hasOwnProperty(S)?(O[0]=1,true):(O[0]=u.Compare(J[S],K[S]),O[0]!==0);}(R))break;if(O[0]===0){for(var S in K)if(function(T){return!K.hasOwnProperty(T)?false:!J.hasOwnProperty(T)&&(O[0]=-1,true);}(S))break;}N=O[0];}return N;}}};u.compareArrays=function(J,K){var L,M;if(n.length(J)<n.length(K))return -1;else if(n.length(J)>n.length(K))return 1;else{L=0;M=0;while(L===0&&M<n.length(J)){L=u.Compare(n.get(J,M),n.get(K,M));M=M+1;}return L;}};u.compareDates=function(J,K){return u.Compare(J.getTime(),K.getTime());};u.Equals=function(J,K){var L,M,N,O;if(J===K)return true;else{L=typeof J;if(L=="object"){if(J===null||J===void 0||K===null||K===void 0)return false;else if("Equals"in J)return J.Equals(K);else if(J instanceof a.Array&&K instanceof a.Array)return u.arrayEquals(J,K);else if(J instanceof a.Date&&K instanceof a.Date)return u.dateEquals(J,K);else{M=[true];for(var P in J)if(function(Q){M[0]=!J.hasOwnProperty(Q)||K.hasOwnProperty(Q)&&u.Equals(J[Q],K[Q]);return!M[0];}(P))break;if(M[0]){for(var Q in K)if(function(R){M[0]=!K.hasOwnProperty(R)||J.hasOwnProperty(R);return!M[0];}(Q))break;}return M[0];}}else return L=="function"&&("$Func"in J?J.$Func===K.$Func&&J.$Target===K.$Target:"$Invokes"in J&&"$Invokes"in K&&u.arrayEquals(J.$Invokes,K.$Invokes));}};u.arrayEquals=function(J,K){var L,M;if(n.length(J)===n.length(K)){L=true;M=0;while(L&&M<n.length(J)){!u.Equals(n.get(J,M),n.get(K,M))?L=false:void 0;M=M+1;}return L;}else return false;};u.dateEquals=function(J,K){return J.getTime()===K.getTime();};v.New=function(J,K){return{c:J,r:K};};w=p.Scheduler=G.Class({Fork:function(J){var K;K=this;this.robin.push(J);this.idle?(this.idle=false,a.setTimeout(function(){K.tick();},0)):void 0;},tick:function(){var J,K,L;K=this;L=I.now();J=true;while(J)if(this.robin.length===0){this.idle=true;J=false;}else{(this.robin.shift())();I.now()-L>40?(a.setTimeout(function(){K.tick();},0),J=false):void 0;}}},s,w);w.New=G.Ctor(function(){s.New.call(this);this.idle=true;this.robin=[];},w);x.Get=function(J){return J instanceof a.Array?x.ArrayEnumerator(J):u.Equals(typeof J,"string")?x.StringEnumerator(J):J.GetEnumerator();};x.ArrayEnumerator=function(J){return new C.New(0,null,function(K){var L;L=K.s;return L<n.length(J)&&(K.c=n.get(J,L),K.s=L+1,true);},void 0);};x.StringEnumerator=function(J){return new C.New(0,null,function(K){var L;L=K.s;return L<J.length&&(K.c=J[L],K.s=L+1,true);},void 0);};y.$cctor=function(){y.$cctor=a.ignore;y.noneCT=v.New(false,[]);y.scheduler=new w.New();y.defCTS=[new B.New()];y.Zero=p.Return();y.GetCT=function(J){J.k({$:0,$0:J.ct});};};A=h.OperationCanceledException=G.Class({},z,A);A.New=G.Ctor(function(J){A.New$1.call(this,"The operation was canceled.",null,J);},A);A.New$1=G.Ctor(function(J,K,L){this.message=J;this.inner=K;q.setPrototypeOf(this,A.prototype);this.ct=L;},A);B=h.CancellationTokenSource=G.Class({},s,B);B.New=G.Ctor(function(){s.New.call(this);this.c=false;this.pending=null;this.r=[];this.init=1;},B);C=x.T=G.Class({MoveNext:function(){return this.n(this);},Current:function(){return this.c;},Dispose:function(){if(this.d)this.d(this);}},s,C);C.New=G.Ctor(function(J,K,L,M){s.New.call(this);this.s=J;this.c=K;this.n=L;this.d=M;},C);G.OnLoad(function(){c.Main();});}());
